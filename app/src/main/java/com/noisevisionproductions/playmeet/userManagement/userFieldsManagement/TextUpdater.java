...
public class TextUpdater {
    public static void updateTextValue(@NonNull EditableField field, @NonNull EditText editText, @NonNull AppCompatSpinner citySpinner, @NonNull AppCompatSpinner ageSpinner, @NonNull AppCompatButton editButton, View view, @NonNull Context context) {
    ...
    private static void setupTextFieldWithUserInformation(@NonNull EditText editText, @NonNull Context context) {
