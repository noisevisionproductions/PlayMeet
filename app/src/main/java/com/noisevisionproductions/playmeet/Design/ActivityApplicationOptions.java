...
public class ActivityApplicationOptions extends SidePanelBaseActivity {
    ...
    private void handleReasonForDelete(AppCompatEditText reasonForDelete) {
    ...
    private void submitReasonForDeleteAccountToDB(String textWithReason, @Nullable Runnable onSuccess, @Nullable Runnable onFailure) {
    ...
    private void deleteUserWithEmailAuth(String password, String reasonText) {
        if (currentUser != null) {
    ...
    private void authenticateAndDeleteUser(AuthCredential credential, String reasonText) {
