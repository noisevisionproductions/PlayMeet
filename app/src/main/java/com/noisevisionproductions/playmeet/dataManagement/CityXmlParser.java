...
// klasa stworzona w celu filtracji miast z API miast w Polsce, który jest w formacie xml.
// Jest on pobrany z oficjalnego portalu API GUS. Plik ten zawiera wszystkie miasta, wsie itp.
// oraz inne informacje, których nie potrzebuje w swojej aplikacji

public class CityXmlParser {

    @NonNull
    public static List<String> parseCityNames(@NonNull Context context) {
        List<String> cityNameList = new ArrayList<>();
        cityNameList.add(context.getString(R.string.choose_city_string_from_spinner));
