...
public class AdapterAllPosts extends RecyclerView.Adapter<AdapterAllPosts.MyViewHolder> {
    ...
    @NonNull
    @Override
    public AdapterAllPosts.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    private void getPeopleStatus(String postId, MyViewHolder holder) {
        FirebaseHelper firebaseHelper = new FirebaseHelper();
    ...
    private void reportPost(MyViewHolder holder, String postId) {
